...
solutionTemplateUri="https://raw.githubusercontent.com/khulnasoft/docker-provider/ci_dev/scripts/onboarding/templates/azuremonitor-containerSolution.json"
