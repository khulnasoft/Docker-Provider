...
#  Note: 'Khulnasoft.Authorization/roleAssignments/write'  permission required on the  cluster resource to add the role assignment.
...
# For example:
#
# https://raw.githubusercontent.com/khulnasoft/docker-provider/ci_prod/scripts/onboarding/aks/mdmonboarding/mdm_onboarding.sh | bash -s "00000000-0000-0000-0000-000000000000" "MyAKSClusterRG" "MyAKSCluster"
#
